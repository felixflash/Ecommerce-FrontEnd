  ...
  return (
    <>
      ...
      <div class="card-group">
        <div class="card">
          <img
            src="https://www.sonyalpharumors.com/wp-content/uploads/2018/12/ebay.jpg"
            class="card-img-top"
            alt="card"
          />
          <div class="card-body">
        ...
        <div class="row g-0">
          ...
          <div class="col-md-8">
            <div class="card-body text-light">
              ...
              <hr></hr>
              <p class="card-text">
                This is the best online platform I have ever been to.
              </p>
              <p class="card-text">
                <small class="text-muted">Last updated 3 mins ago</small>
              </p>
      ...
      <div class="card bg-dark mb-3">
        <div class="row g-0">
          <div class="col-md-4">
            <img
              src="https://www.gannett-cdn.com/-mm-/2f927176fc1e8e0a31a6f6117d6cbdf9b1e47589/c=348-61-1367-637/local/-/media/2015/09/18/USATODAY/USATODAY/635781741516984466-Luckie.jpg?auto=webp&format=pjpg&width=1200"
              class="img-fluid rounded"
              alt="card"
            />
          </div>
          <div class="col-md-8">
            <div class="card-body text-light">
              ...
              <hr></hr>
              <p class="card-text">
                I'm so happy and satisfied with the products here .
              </p>
              <p class="card-text">
                <small class="text-muted">Last updated 3 mins ago</small>
              </p>
      ...
      <footer class="footer">
        ...
        <div class="footer-left col-md-4 col-sm-6">
          <p class="about">
            <span className="text-warning"> About Us</span> We are committed to
            helping people get whatever they want and be satisfied with it.
          </p>
          <div class="icons">
            <a href="https://web.facebook.com/profile.php?id=100072122181777&_rdc=1&_rdr">
            ...
            <a href="https://www.instagram.com/isellapp/">
        ...
        <div class="footer-center col-md-4 col-sm-6">
          <div>
            ...
            <p>
              <span className="text-warning"> Knust</span> KSI-GHANA
            </p>
          </div>
          <div>
