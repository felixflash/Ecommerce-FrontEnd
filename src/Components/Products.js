    ...
    <>
      ...
      <footer class="footer">
        <div class="footer-left col-md-4 col-sm-6">
          <p class="about">
            <span> About Us</span> We are committed to helping people get
            whatever they want and be satisfied with it.
          </p>
          <div class="icons">
        ...
        <div class="footer-center col-md-4 col-sm-6">
          ...
          <div>
            ...
            <p>
              <a href="www.gmail.com"> Help by emailing us</a>
            </p>
          </div>
        </div>
