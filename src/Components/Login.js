    ...
    <section id="logincontainer">
      ...
      <div class="bg-dark p-5 text-dark bg-opacity-25">
        <div className="container bg-dark text-light">
          ...
          <form autoComplete="off" className="form-group" onSubmit={login}>
            ...
            <div className="buttonspace">
              <h5>
                <button
                  type="submit"
                  className="badge text-light btn-lg badge-secondary badge-pill badge-border no-fill "
                >
                  <i
                    class="fa fa-sign-out fa-spin fa-1x fa-fw text-warning"
                    aria-hidden="true"
                  ></i>{" "}
                  L O G I N
                </button>
          ...
          <br />
          <a href="signup">
            Don't have an account at I-sell? Register <span>Here</span>
          </a>
        </div>
      </div>
    </section>
